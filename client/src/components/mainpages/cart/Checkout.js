...
export default function Checkout({ history }) {
  ...
  useEffect(() => {
    const getTotal = () => {
      const offer = total >= 300 ? "Free 1kg Potato" : "";
      setOffer(offer);
    };
    getTotal();
  });
    ...
    <>
      ...
      <div className="checkout_container">
        ...
        <div className="check_amount" style={{ padding: "10px" }}>
          ...
          <p style={{ textAlign: 'center', fontWeight: 'bold', letterSpacing: '1px' }}> {offer}</p>
        ...
        <div className="address_contain_wraper">
          ...
          <div className="address_inner_contain_wraper">
            <div style={{ textAlign: "center", marginBottom: '3px', fontWeight: 'bold', fontSize: '14px' }}>
              We Deliver between 10:00 AM to 07:00 PM{" "}
            ...
            <div className="extrat" style={{ alignItems: 'center', textAlign: 'center', color: 'green', fontSize: '14px', fontWeight: '500' }} >
              <img src={Delivery} alt="delivery" width="30" />
              We Deliver Only in Nalbari Town  .
            </div>
            <p
              style={{
                fontWeight: "bold",
