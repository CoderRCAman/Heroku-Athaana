...
function CreateProduct() {
    ...
    const handleDestroy = async () => {
        try {
            if(!isAdmin) return alert("You're not an admin")
            setLoading(true)
            await axios.post('/api/destroy', {public_id: imageData.public_id}, {
    ...
    const handleSubmit = async e =>{
        ...
        try { 
            ...
            if(onEdit){
                await axios.put(`/api/products/${product._id}`, {...product, images:imageData}, {
                    headers: {Authorization: token}
                })
            }else{
                await axios.post('/api/products', {...product, images:imageData}, {
                    headers: {Authorization: token}
                })
            }
        ...
        <div className="create_product">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    ...
                    <input type="number" name="pricemk" id="pricemk" 
                    value={product.pricemk == null ? '' : product.pricemk} onChange={handleChangeInput} />
                ...
                <div className="row">
                    ...
                    onChange ={ date => setProduct({
                        ...product,startDate:JSON.stringify(date)
                    })}
                ...
                {/* <div className="row" >
                    ...
                    onChange ={date => setProduct({
                        ...product,endDate:JSON.stringify(date)
                    })}
